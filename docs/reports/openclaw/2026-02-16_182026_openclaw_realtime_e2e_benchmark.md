...
- Generated: `2026-02-16T14:20:26.217706+00:00`
- Window minutes: `90`
- Status: `warn`
...
| hook_spool_llm_input_output | `pass` | `{'llm_input_window': 16, 'llm_output_window': 16}` |
| hook_ingested_to_queue | `pass` | `{'hook_rows_window': 30}` |
...
- Hook spool (window): input=16 output=16
- Hook ingest queue rows (window): 30
