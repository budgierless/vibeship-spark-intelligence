...
- Generated: `2026-02-16T14:07:23.235911+00:00`
- Window minutes: `90`
- Status: `fail`
...
| hook_spool_llm_input_output | `pass` | `{'llm_input_window': 8, 'llm_output_window': 8}` |
| hook_ingested_to_queue | `pass` | `{'hook_rows_window': 14}` |
...
| openclaw_canary_turns | `fail` | `{'agent': 'spark-speed', 'turns_ok': [False, False]}` |

## Live Signal Snapshot

- Hook spool (window): input=8 output=8
- Hook ingest queue rows (window): 14
