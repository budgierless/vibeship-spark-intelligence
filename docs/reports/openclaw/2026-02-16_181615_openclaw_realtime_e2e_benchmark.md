...
- Generated: `2026-02-16T14:16:15.822018+00:00`
- Window minutes: `90`
- Status: `pass`
...
| hook_spool_llm_input_output | `pass` | `{'llm_input_window': 12, 'llm_output_window': 11}` |
| hook_ingested_to_queue | `pass` | `{'hook_rows_window': 21}` |
...
- Hook spool (window): input=12 output=11
- Hook ingest queue rows (window): 21
