...
- `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`
...
- Advisory self-review (12h window) shows advisory trace coverage at 0/11 (0%), and engine trace coverage at 3/13 (23.08%), which blocks attribution. Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`.
- Advisory noise is highly concentrated in that same 12h window: "Top repeated advisories account for ~92.0% of all advice items". Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`.
...
- Constraint: in exactly one state at all times. Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`, `%USERPROFILE%\\.spark\\advisory_emit.jsonl`.
- Always read a file before Edit to verify current content. Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`, `%USERPROFILE%\\.spark\\advisory_emit.jsonl`.
...
- Suppress long repeated "When using Bash..." advisory family (high repetition in window, low actionability for PowerShell-first operation). Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`.
- Suppress long repeated "lets push gitthub..." advisory family (high repetition, not tied to current acceptance). Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`, `%USERPROFILE%\\.spark\\advice_feedback_requests.jsonl` (recent window counts below).

### Next Week: 3 Bets (Measurable + Rollback)
1. Improve advisory trace discipline end-to-end. Metric: advisory trace coverage from 0% toward >=60%. Rollback: revert strict trace requirements if strict effectiveness drops. Evidence baseline: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`.
2. Reduce repeat-noise concentration. Metric: top-repeat share from ~92% toward <=40%. Rollback: if critical misses increase. Evidence: `docs/archive/docs/reports_self_review/2026-02-15_124723_advisory_self_review.md`, `docs/reports/2026-02-13_advisory_repeat_abcd_controlled_delta_v1.md`.
