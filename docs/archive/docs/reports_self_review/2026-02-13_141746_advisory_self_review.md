# Advisory Self-Review (2026-02-13T14:17:46.541950+00:00)
...
## Core Metrics
- Advisory rows: 1041
- Advisory trace coverage: 1013/1041 (97.31%)
- Advice items emitted: 2161
- Engine events: 500
- Engine trace coverage: 249/500 (49.8%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.896
- Strict effectiveness rate: 0.942
...
- `delta-noise_D_mixed_light-20260213_141650-0024` | tool `Read` | source `cognitive` | Always Read a file before Edit to verify current content
- `delta-noise_D_mixed_light-20260213_141650-0023` | tool `WebFetch` | source `self_awareness` | [Caution] I struggle with WebFetch fails with other tasks
- `delta-noise_D_mixed_light-20260213_141650-0022` | tool `Edit` | source `cognitive` | Always Read a file before Edit to verify current content
- `delta-noise_D_mixed_light-20260213_141650-0020` | tool `Read` | source `cognitive` | Always Read a file before Edit to verify current content
- `delta-noise_D_mixed_light-20260213_141650-0019` | tool `WebFetch` | source `self_awareness` | [Caution] I struggle with WebFetch fails with other tasks
- `delta-noise_D_mixed_light-20260213_141650-0017` | tool `Edit` | source `cognitive` | Always Read a file before Edit to verify current content
- `delta-noise_D_mixed_light-20260213_141650-0015` | tool `WebFetch` | source `self_awareness` | [Caution] I struggle with WebFetch fails with other tasks
- `delta-noise_D_mixed_light-20260213_141650-0014` | tool `Edit` | source `cognitive` | Always Read a file before Edit to verify current content
...
- Yes. Top repeated advisories account for ~80.2% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 789x (36.51%) Constraint: in **exactly one state** at all times
- 248x (11.48%) lets push gitthub, and then clean up the whole system except this spark, and at some point we were thinking to bring the council of 50, as the agents can you se
- 219x (10.13%) Always Read a file before Edit to verify current content
- 162x (7.5%) [Caution] I struggle with WebFetch fails with other tasks
- 159x (7.36%) [Caution] I struggle with WebFetch fails with other (recovered) tasks
- 156x (7.22%) [Caution] I struggle with WebFetch_error tasks
