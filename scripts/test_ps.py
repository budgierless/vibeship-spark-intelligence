...
script = r"C:\Users\USER\Desktop\vibeship-spark-intelligence\scripts\claude_call.ps1"

prompt_file.write_text("What is 2+2? Reply with just the number.", encoding="utf-8")
if response_file.exists():
    response_file.unlink()

# start /wait /min launches a new console window (minimized) — this gives Claude its TTY
